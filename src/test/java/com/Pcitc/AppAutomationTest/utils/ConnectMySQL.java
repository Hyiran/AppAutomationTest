...
* @return obect[][]
*/
public static Object[][] getObjectData(String sql)
{
...
//	更新语句
//	mysql.getSqlResault("update WebGenerateData set qingjia='123' where shouquanshenqing='6'",false);  	
//	查询语句
  List<HashMap<String, String>> rs =mysql.getSqlResault("select * from WebGenerateData where terminal='android'  and datano=1",true);   
  System.out.println(rs);

//  查询语句获得object[][]
//  Object a[][]=ConnectMySQL.getObjectData("SELECT * from WebGenerateData ");
//  
////  获得指定行指定列数据
//	System.out.println(rs.get(3).get("feiyongbaoxiao"));
//	String aString=rs.get(3).get("feiyongbaoxiao");
////  获得指定行数据
...
public Object[][] mysqlDp() 
{
	ConnectMySQL mysql= new ConnectMySQL();
	mysql.connect("localhost:3306/pcitc", "root", "fu~123");
	Object a[][]=ConnectMySQL.getObjectData("SELECT * from table");
	return a;

//  List<HashMap<String, String>> rs = ConnectMySQL.query("SELECT * from login");    
//  System.out.println(rs.get(0).get("id"));
//  System.out.println(rs.size());
//  Log.logError(String.valueOf(rs.size()));
}
...
* @param c第三列的别名
*/
//public  void jh(String a,String b,String c,String d,String e)
//{ 

public  void jh( Map<String, String> param)
{
...
//	mysql.getSqlResault("update WebGenerateData set qingjia='123' where shouquanshenqing='6'",false);  	
//	查询语句
  List<HashMap<String, String>> rs =mysql.getSqlResault("select * from WebGenerateData where terminal='android'  ",true);   
